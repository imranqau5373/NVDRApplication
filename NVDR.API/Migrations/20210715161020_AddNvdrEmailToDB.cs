...
{
    public partial class AddNvdrEmailToDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NvdrEmails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NvdrEmails_NvdrRecords_NvdrDeviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NvdrEmails_NvdrDeviceId",
                table: "NvdrEmails",
                column: "NvdrDeviceId");
        }
